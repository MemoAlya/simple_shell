...
/**
 * __cd_error - an error is printed if directory fail to change
...
/**
 * __cd_success - the environment is changed after success
 * @info: shell information
 */
...
/**
 * __cd - the directory is changed
 * @info: the arguments succeeded
 *
 * Return: interger
 */
