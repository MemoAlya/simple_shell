...
/**
 * env_to_dict - function creates a list from environment
...
/**
 * _env_to_dict - function turns the environment into a linked list 
 * @tailptr: ptr to the tail of the list
 * @env: environment
 *
 * Return: ptr to the tail of the list
 */
