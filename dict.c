...
/**
 * get_dict_val - function gets a value from a dictionary
 * @head: dict
 * @key: entry key
 *
 * Return: ptr to the entry value
 */
...
/**
 * get_dict_node - function retrieves a node by key
 * @head: dict
 * @key: entry key
 *
 * Return: node or NULL
...
/**
 * add_dict_node_end - function adds node at the end of list
...
/**
 * del_dict_node - function to delete a node
 * @headptr: ptr to dict
 * @key: entry key
 *
 * Return: ptr to resulting list
 */
...
/**
 * free_dict - function frees a linked list and and set head to NULL
