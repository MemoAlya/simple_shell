...
/**
 * dequote - function to dequote a string
 * @str: the str to dequote
...
/**
 * dequote_len - function to compute the length of a string after dequoting
 * @str: the str to check
 * Return: Fucntion returns the length of str after dequoting
 */
