...
/**
 * cmd_to_list - function to construct a linked list of tokenized commands
...
/**
 * _cmd_to_list - function to construct a linked list of tokenized commands
 * @tailptr: ptr to tail of the command list
 * @split: a line split with null bytes on separators
 * @count: the num of commands contained in split
 *
 * Return: If memory allocation fails, return NULL. Otherwise, return a
