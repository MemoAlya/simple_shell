...
/**
 * error_get_cd - Function gets error message for cd command in get_cd
...
/**
 * error_not_found - Prints generic error message for command not found
 * @datash: data relevant
 * Return: Error message
 */
...
/**
 * error_exit_shell - Function prints error message for exit in get_exit
 * @datash: data needed 
 *
 * Return: Error messg
 */
