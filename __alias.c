...
/**
 * __alias_add - alias added to an existing list
 * @aliases: a list of aliases pointed
 * @name: the alias name
 * @value:the alias outcome value
 */
...
/**
 * __alias_print -an alias printed
...
/**
 * __alias -  aliases created and displayed
